...
if flag:
    # 导入节点 电影类型  == 注意类型转换
    print('Load gener...')
    cypher = """LOAD CSV WITH HEADERS  FROM "file:///data/IMDB/genre.csv" AS line MERGE (p:Genre{gid:toInteger(line.genre_id),name:line.genre_name})"""
    graph.run(cypher)
